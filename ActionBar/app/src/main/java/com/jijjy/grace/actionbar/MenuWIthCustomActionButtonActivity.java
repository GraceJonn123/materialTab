...
public class MenuWIthCustomActionButtonActivity extends ActionBarActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu){
        //inflate the menu:this adds actions to the action bar if it is present.
...
//    a placeholder fragment containgin a simple view
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        //action button just as a regular view!
        Button centerActionButton = (Button) rootView.findViewById(R.id.centerActionButton);

        //adding some items to the menu. They are regular views as well.
