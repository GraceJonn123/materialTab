...
//        fabIconNew.setImageDrawable(getResources().getDrawable(R.drawable.ic_action_new_light, getTheme()));
//        WindowManager.LayoutParams params = FloatingActionButton.Builder.;
//
