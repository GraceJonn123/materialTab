...
public abstract class MenuInScrollViewActivity extends ActionBarActivity implements FloatingActionMenu.MenuStateChangeListener, ViewTreeObserver.OnScrollChangedListener, View.OnLayoutChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //To attach a menu to the button in the bottom bar, JUst to prove that it works.
    ...
    public void onMenuOpened(FloatingActionMenu menu) {
        //only allows one menu to stay open
